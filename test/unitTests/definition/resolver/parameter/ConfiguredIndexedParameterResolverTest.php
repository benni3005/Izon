 ...
 */
class ConfiguredIndexedParameterResolverTest extends TestCase {

  /**
   *
   * @var ConfiguredIndexedParameterResolver
   */
  private $sut = null;
  ...
  protected function setUp() {
    ...
    $this->sut = new ConfiguredIndexedParameterResolver();
  }

  /**
   *
   * @covers \derbenni\wp\di\definition\resolver\parameter\ConfiguredIndexedParameterResolver::can
   */
  ...
  /**
   *
   * @covers \derbenni\wp\di\definition\resolver\parameter\ConfiguredIndexedParameterResolver::resolve
   */
  public function testResolve_CanReturnTheConfiguredArguemntValue() {
    $parameter = new ReflectionParameter([ParameterResolverTestDummy::class, 'unspecifiedParameter'], 'foo');
    $container = $this->getMockBuilder(Container::class)->disableOriginalConstructor()->getMock();

    self::assertEquals('bar', $this->sut->resolve($parameter, $container, [0 => 'bar']));
  }
}
