...
class ClassNameParameterResolverTest extends TestCase {
  ...
  /**
   *
   * @covers \derbenni\wp\di\definition\resolver\parameter\ClassNameParameterResolver::can
   */
  ...
  /**
   *
   * @covers \derbenni\wp\di\definition\resolver\parameter\ClassNameParameterResolver::resolve
   */
