...
class ConfiguredNamedParameterResolverTest extends TestCase {
  ...
  /**
   *
   * @covers \derbenni\wp\di\resolver\parameter\ConfiguredNamedParameterResolver::can
   */
  ...
  /**
   *
   * @covers \derbenni\wp\di\resolver\parameter\ConfiguredNamedParameterResolver::resolve
   */
