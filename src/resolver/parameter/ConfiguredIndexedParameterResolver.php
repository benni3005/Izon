...
/**
 * This resolver is responsible for resolving parameters, that have the same index in the configured arguments as it.
 *
 * @author Benjamin Hofmann <benni@derbenni.rocks>
 *
 * @since 1.0
 */
class ConfiguredIndexedParameterResolver implements iParameterResolver {

  /**
   * Checks if the arguments array contains an entry with the same index as the parameters' position.
   *
  ...
  /**
   * Returns the configured value of the arguments array by using the parameters' position index.
   *
